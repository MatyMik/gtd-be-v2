...
export class Migration20230317070730 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "next_action" ("id" serial primary key, "name" varchar(255) not null, "deadline" timestamptz(0) null, "tags" text[] null, "done" boolean not null default false, "description" varchar(255) null, "project_id" int not null, "user_id" int not null, "created_at" timestamptz(0) not null);');
